AseidenNimet = {
	...
	[tostring(GetHashKey('WEAPON_PISTOL_MK2'))] 			= 'Pistol Mk.2',
	...
	[tostring(GetHashKey('WEAPON_DOUBLEACTION'))] 			= 'Kultanen rellu',
	...
	[tostring(GetHashKey('WEAPON_HEAVYSNIPER_MK2'))] 		= 'Heavy Sniper Mk.2',
	...
	[tostring(GetHashKey('WEAPON_SNSPISTOL_MK2'))] 			= 'SNS Pistol Mk.2',
